...
- **La mesa**: todos ven los dispositivos **en el orden de asiento** (sentido horario), que se ajusta **arrastrando el asa ⠿** y se recuerda entre partidas y juegos. Cada dispositivo se marca como jugador o solo-pantalla, puede elegirse como **🔊 narrador** de los modos automáticos (el creador de la mesa lo es por defecto; se cambia eligiendo a otro dispositivo y se recuerda para todos los juegos), se puede expulsar, y cualquiera elige el juego (o lo cambia, o elimina la mesa, que libera el nombre).
- **Lobby de Castronegro**: un botón **📖 Explicación** abre en cualquier pantalla una introducción ambientada y el «cómo se juega» desde el móvil; su altavoz 🔊 hace que el dispositivo narrador la lea en voz alta para toda la mesa. Cualquiera elige los roles de la partida y los ajustes: revelar rol al morir, composición pública, alguacil, **primera noche sin sangre** (la manada se presenta sin devorar), **vidente solo ve el bando** (lobo o no, sin rol exacto), y **ocultar causas de muerte nocturnas** (solo se anuncia quién murió). El **número de lobos** (auto oficial o fijado del 1 al 4) y el **número de aldeanos** (auto = rellenan los huecos, o un número reservado) se eligen en el menú de roles; si con ello no caben todos los roles activados, se sortea cuáles entran y el resto se anuncia como no repartido — la partida siempre es jugable.
...
- **Palabras clave** 🔑: si hay Cupido o Gaitero en juego, cada jugador recibe una palabra clave secreta junto a su rol (p. ej. «Cuervo de Ceniza»), distinta en cada partida. De noche todos juegan con los ojos cerrados; cuando hay que despertar a jugadores elegidos en oculto (enamorados, encantados), la voz los llama por sus palabras clave y solo ellos abren los ojos con disimulo para mirar su pantalla: nadie sabe a quién habla, como el toque en el hombro del narrador. **Una palabra pronunciada solo se renueva si puede volver a sonar**: con el Gaitero realmente repartido, el enamorado recibe una palabra nueva al confirmar (su panel lo indica claramente), porque una llamada de encantamiento podría nombrarlo después; sin gaitero en juego las palabras quedan fijas toda la partida. Las llamadas falsas usan **señuelos** — palabras que no pertenecen a nadie, distintas cada noche —, de modo que nunca queman la palabra de un jugador real. Si el Gaitero muere con roles ocultos, la voz hace llamadas falsas para disimular.
...
- **Composición secreta de verdad** 🎭: con la composición pública desactivada, los roles activados que no cupieron en el reparto no se anuncian como descartados, y la voz **finge sus turnos** cada noche (llamada, espera y despedida idénticas), incluidas llamadas falsas de Cupido y del Gaitero con palabras clave al azar: nadie puede saber qué cartas juegan de verdad.
- **Chuleta 🎴 Cartas**: durante la partida, un botón en la barra inferior (en los tres modos) muestra los roles presentes — los reales con composición pública, o todos los activados al empezar con composición secreta. Antes de empezar, la Explicación incluye además los roles activados y un resumen de los ajustes elegidos (si se revelan roles al morir, composición, etc.).
...
- **Rol oculto por defecto** 🙈: la carta no se muestra sola ni siquiera al repartir — un botón «👁 Ver mi rol» la despliega cuando nadie mira tu pantalla, y tras confirmar queda oculta. Durante la partida, «👁 Mostrar mi rol» la enseña (con la palabra clave) y se auto-oculta a los 12 segundos, para que nadie la vea de reojo con el móvil sobre la mesa.
...
- **Domador**: su oso gruñe al amanecer (también por voz) si un lobo vive junto a él — o siempre, si el propio Domador está infectado.
- **Albino a solas con la manada**: si solo quedan lobos y el Albino no está en minoría de voto, la partida sigue (él aún puede quedarse solo); con la manada en mayoría, ganan los lobos.
