<script lang="ts">
  ...
  // Lo que exige ESTA misión (cuántos van y cuántos sabotajes la hunden) va
  // delante, y cada ficha lleva su historial público: el líder decide con la
  // mesa a la vista, no de memoria. El contador de rechazos no se repite aquí:
  // es del tablero, que está justo encima.
...
{:else}
  <div class="card">
    ...
    <p class="small-note" data-a="av-propose-pending">⏳ Su elección no aparece hasta que la propone. Mientras tanto: repasa el tablero y decide ya si vas a aprobar o a rechazar.</p>
    <details class="avref">
