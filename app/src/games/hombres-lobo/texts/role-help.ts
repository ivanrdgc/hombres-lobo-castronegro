...
export const ROLE_HELP: Record<RoleId, RoleHelp> = {
  ...
  caballero: {
    ...
    steps: [
      ...
      'Si los lobos te devoran, el lobo más cercano a ti en la mesa queda infectado por el óxido y morirá al amanecer siguiente (la app lo resuelve y lo anuncia).',
    ],
  },
  juez: {
    when: 'De día (una vez)',
