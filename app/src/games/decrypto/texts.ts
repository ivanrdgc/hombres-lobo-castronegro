...
export const HOW_TO: HelpSection[] = [
  {
    heading: '🎯 De qué va',
    items: [
      'Dos equipos, rojo y azul. Cada equipo tiene 4 PALABRAS CLAVE numeradas del 1 al 4, que solo ven los de ese equipo (la app las custodia).',
  ...
  },
  {
    ...
    items: [
      'Por turnos, un equipo transmite. La app da a su ENCRIPTADOR (rota cada ronda) un código secreto de 3 cifras distintas del 1 al 4, por ejemplo 4-2-1.',
