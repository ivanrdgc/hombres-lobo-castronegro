...
<div class="card">
  ...
  <p class="small-note">El orden es el de la mesa (marca el turno de las pistas).</p>
</div>

<div class="card">
  <h3>🔊 ¿Dónde suena la voz?</h3>
  <p class="small-note" style="margin-top:6px">La voz solo anuncia el tema (público) y el desenlace; nunca la palabra secreta. Puede ponerla alguien que también juega.</p>
...
<div class="card">
  ...
  {#if n < MIN_PLAYERS}<p class="small-note">⚠️ El Camaleón necesita al menos {MIN_PLAYERS} jugadores.</p>{/if}
  ...
  <button class="primary block" disabled={!okStart} data-a="ch-start" onclick={startNow}>🦎 ¡Empezar!</button>
</div>
