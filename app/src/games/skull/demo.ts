  ...
  steps: [
    {
      ...
      visual: { kind: 'card', emoji: '🃏', title: 'Tu mano', lines: ['🌸 🌸 🌸 💀', 'Solo tú sabes cuáles pones y en qué orden.'] },
    },
    {
      icon: '🌸',
      title: 'Colocación de salida (todos a la vez)',
      who: { actor: 'TODOS colocáis a la vez UN disco boca abajo', others: 'nadie ve lo que ponen los demás: en la mesa, las pilas ajenas salen tapadas.' },
      text: [
        'Tú pones una flor. ¿Bea? ¿Carlos? Ni idea: eso ES el juego.',
        'Tus discos y tu pila están SIEMPRE en tu pantalla, destapados y sin abrir nada: el móvil se sujeta mirándote, como una mano de cartas. Si se te olvida una regla, la pastilla flotante «Reglas», abajo a la derecha, las tiene todas sin salir de la partida.',
      ],
      visual: {
        kind: 'screens',
        panes: [
          { title: 'TÚ', lines: ['Tu mano: 🌸🌸🌸💀', 'Tu pila: 🌸 (la ves destapada)'], buttons: [{ label: 'Poner una flor 🌸', kind: 'primary' }, { label: 'Poner la calavera 💀', kind: 'danger' }] },
          { title: 'Lo que ves de Bea', lines: ['Su pila: 🎴 (tapada)', '⭐ 0/2 retos · 💠 4 · ✋ 3 en mano'] },
        ],
      },
    },
    {
      ...
      who: { actor: 'Bea (su turno) elige: poner otro disco o abrir la apuesta', others: 'tú y Carlos esperáis; su ficha se enciende en la mesa para que se sepa a quién le toca.' },
      text: [
    ...
    },
    {
      ...
      ask: {
        prompt: '¿Qué haces?',
        choices: [
          { label: '🤐 Pasar: que se la juegue Carlos', good: true, reply: 'Muy sano: pasar es definitivo para la ronda (ya no vuelves a pujar), y quien acaba pujando más alto es quien arriesga. Si crees que hay calaveras sembradas, deja que se estrelle otro.' },
    ...
    },
    {
      ...
      visual: {
        kind: 'screens',
        panes: [
          { title: 'Carlos (revela)', lines: ['🎲 Lleva 🌸⚪ 1/2 · falta 1'], buttons: [{ label: '👆 Levantar el de arriba de TU pila', kind: 'danger' }, { label: '👆 Levantar el de arriba de Ana', kind: 'danger' }] },
          { title: 'TÚ', lines: ['«🎲 Carlos se la juega: 2 flores seguidas»', 'Ves cada disco que levanta, destapado en la mesa.'] },
        ],
      },
    },
    {
      ...
      text: [
        'Si tu disco era una FLOR 🌸: Carlos completa sus 2 flores y gana el reto (⭐ una victoria; con dos, la partida). Si era la CALAVERA 💀: falla y pierde un disco AL AZAR de los suyos — puede tocarle su calavera o una flor. Quien se queda sin discos, FUERA de la partida.',
