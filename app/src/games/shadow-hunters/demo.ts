...
export const DEMO: DemoScript = {
  ...
  steps: [
    ...
    },
    {
      ...
      who: { actor: 'TÚ abres la pastilla 🎴 Mi carta, abajo a la derecha, cuando quieras', others: 'en el tablero TODOS salís como «❓ sin destapar», tú incluido.' },
      text: [
      ...
      visual: {
        kind: 'screens',
        panes: [
          { title: 'TÚ, al abrir 🎴 Mi carta', lines: ['🐺 Licántropo · 🌑 las Sombras', 'Poder al revelarte: te curas 3 puntos.', '🙈 Se tapa sola en unos segundos.'] },
    ...
    },
    {
      ...
      who: { actor: 'Bea (su turno) elige «🔮 Dar una pista» y te señala a TI', others: 'la mesa VE que te da una pista y el resultado… pero el texto solo lo leéis Bea y tú.' },
      text: [
        'En los cinco móviles aparece el mismo aviso: «hay una pista sin leer». Leerla solo podéis Bea y tú, así que el aviso no delata a quién le ha tocado; los demás pueden tocarlo y no verán nada.',
        'Al leerla, tu pantalla dice: «Si eres Sombra, pierdes 1 punto de vida»… y lo pierdes ❤️. Bea ya SABE que eres Sombra (¡lo leyó al darla!). El resto solo ve que perdiste vida: deducen que la pista «te pilló».',
        'El texto se tapa solo a los pocos segundos, y el aviso no se retira hasta que los DOS pulsáis «Entendido»: nadie te lo puede cerrar antes de que lo leas.',
      ...
      visual: {
        kind: 'screens',
        panes: [
          { title: 'TÚ (lees la pista)', lines: ['🔮 «Si eres Sombra, pierdes 1 punto de vida.»', 'Resultado público: pierdes 1 ❤️.'], buttons: [{ label: 'Entendido', kind: 'ghost' }] },
          { title: 'Carlos (toca el aviso)', lines: ['🤫 «Esta no es tuya».', '📜 «Bea entrega una pista a ti… y pierdes 1 punto de vida.»'] },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      text: [
        ...
        'Deduce con las pistas, miente con soltura y guarda tu poder para el momento justo. Tu personaje y las reglas —los ocho personajes y las ocho pistas— están siempre en el mismo sitio: la pastilla 🎴 Mi carta, abajo a la derecha.',
      ],
