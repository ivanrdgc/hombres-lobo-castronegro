  ...
  steps: [
    {
      ...
      text: [
        ...
        'Cazadores ganan si mueren TODAS las Sombras; Sombras, si mueren TODOS los Cazadores. Todos empezáis con 10 puntos de vida ❤️… y sin saber quién es quién.',
      ],
    },
    {
      icon: '🎴',
      ...
      visual: {
        ...
        panes: [
          ...
          { title: 'Lo que ven de ti', lines: ['TÚ · ❓ oculto · ❤️ 10', 'Un nombre, una vida y un misterio.'] },
        ],
      },
    },
    {
      ...
      text: [
        'Tu pantalla dice: «Si eres Sombra, pierdes 1 punto de vida»… y pierdes 1 ❤️. Bea ya SABE que eres Sombra (¡lo leyó al darla!). El resto solo ve que perdiste vida: deducen que la carta «te pilló».',
        'Cada turno es UNA acción: pista, ataque, descanso o revelarse.',
      ],
      visual: {
        kind: 'screens',
        panes: [
          ...
          { title: 'Carlos (mira la mesa)', lines: ['📜 «Bea entrega una pista a TÚ… y pierde 1 punto de vida.»', 'Hmm. ¿Qué ponía esa carta?'] },
        ],
      },
    },
    {
      ...
      text: ['Eres el Licántropo (Sombra) con 9 ❤️. Bea acaba de leer tu pista: sospecha de ti. ¿Qué haces?'],
      ask: {
        prompt: '¿Qué haces?',
        choices: [
    ...
    },
    {
      ...
      text: [
        'La app tira 1 dado de 6 y 1 de 4: el daño es la DIFERENCIA (empate = fallo). Carlos saca 5 y 2 → 3 de daño a David. No hace falta saber quién es: se ataca por sospecha… o por si acaso.',
        'Cuando alguien llega a 0 ❤️ queda eliminado y su personaje se destapa para todos.',
      ],
      visual: { kind: 'log', lines: ['⚔️ Carlos ataca a David: dados 5 y 2 → 3 de daño.', '💊 David descansa y recupera 1 punto de vida.', '🔮 Emma entrega una pista a Carlos… y no le afecta.'] },
    },
    {
      icon: '🎭',
      title: 'Revelarse: el momento crítico',
      who: { actor: 'Emma (su turno, con 3 ❤️) pulsa «🎭 Revelarte» y elige objetivo', others: 'la mesa entera descubre su identidad y sufre su poder.' },
      text: [
    ...
    },
    {
      ...
      text: [
        ...
        'Deduce con las pistas, miente con soltura y guarda tu poder para el momento justo. Tu 🎴 siempre lleva la chuleta de todos los personajes. 🌘',
      ],
