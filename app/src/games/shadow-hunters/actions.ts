...
export async function startShadowH(playerIds: string[], narratorId: string | null): Promise<void> {
  ...
  const game: ShadowHState = {
    ...
    log: [
      { txt: '🌘 Comienza Shadow Hunters. Cazadores, Sombras y neutrales con identidad SECRETA: dejad el móvil plano en la mesa y abrid vuestro personaje en 🎴 Mi carta, la pastilla de abajo a la derecha, cuando queráis. En tu turno: pista, ataque, descanso… o revélate y usa tu poder.' },
