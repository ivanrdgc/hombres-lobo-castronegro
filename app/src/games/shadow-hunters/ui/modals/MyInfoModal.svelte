<script lang="ts">
  ...
  // 🍽️ MESA (B28): abrir este modal ya era un gesto, pero se quedaba abierto
  // con tu personaje escrito hasta que lo cerrabas — y el móvil vuelve a la
  // mesa enseguida. Ahora lo tuyo va tras el mismo 👁 que en la partida (se
  // tapa solo); lo público —el reparto, los 8 personajes, las 8 pistas y cómo
  // se gana— se queda a la vista, que para eso es público.
...
{#if game && my}
  ...
  <h3 style="margin:16px 0 4px">📖 Lo que sabe toda la mesa</h3>
